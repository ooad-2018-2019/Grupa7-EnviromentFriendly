...
namespace CalTrek.Controllers
{
    public class KlijentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Username,Ime,Prezime,DatumRodjenja,Spol,Grad,Drzava")] Klijent klijent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Username,Ime,Prezime,DatumRodjenja,Spol,Grad,Drzava")] Klijent klijent)
        {
            if (id != klijent.Id)
            {
                return NotFound();
